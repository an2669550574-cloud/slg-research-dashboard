...
kingsgroup；Century 系 = century games/diandian），不臆造新关联；
...
SEED_PUBLISHERS: tuple[dict, ...] = (
    ...
    # century games 是其海外发行马甲，diandian 为国内名兜底。
    # 注：first fun / firstfun 不归点点——First Fun 是元趣娱乐（Last War 研发商），见下「元趣娱乐」条。
    # 注：building blocks 不归点点——BUILDING-BLOCKS Network Technology 是三七的海外开发者主体
    #（Puzzles & Survival/Conquest、Z Route 等），见下「三七互娱」条。
    {"name": "点点互动", "name_en": "Diandian Interactive / Century Games", "hq_region": "国内", "is_slg": True,
     "brief": "世纪华通全资子公司；海外发行品牌 Century Games（新加坡发行主体 Century Games Pte. Ltd.）。Whiteout Survival / Kingshot。",
     "aliases": [("century games", "Century Games"), ("diandian", "Diandian")], "app_ids": []},
    ...
    {"name": "三七互娱", "name_en": "37 Interactive", "hq_region": "国内", "is_slg": True,
     "brief": "Puzzles & Survival / Puzzles & Conquest / Z Route 等；海外开发者马甲 BUILDING-BLOCKS Network Technology（building blocks）。",
     "aliases": [("37 mobile games", "37 Mobile Games"), ("37games", "37Games"),
                 ("37 interactive", "37 Interactive"), ("building blocks", "Building Blocks")], "app_ids": []},
