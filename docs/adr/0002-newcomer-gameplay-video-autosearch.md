...
- 2026-06-27:**视频搜集 job 03:50 → 02:45 UTC + 进每日 digest**——把「新品实机视频」推进钉钉每日卡（领导免开网站）。原 job 在 digest(03:00) 之后，当天新品的视频赶不上当天卡；移到核心同步(02:30~02:38)之后、digest 之前，视频在拼卡时已就位。digest 新增【新品实机视频】段（只取非隐藏，尊重软删）。
