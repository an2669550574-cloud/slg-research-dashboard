...
export const en: Translations = {
  ...
  dashboard: {
    ...
    periodSub: (n: number) => `last ${n} days`,
    statDownloadsTotal: (n: number) => `Total downloads · last ${n}d`,
    statRevenueTotal: (n: number) => `Total revenue · last ${n}d`,
    statTopGameTotalSub: 'Top by revenue',
    aggBoardTitle: (n: number) => `${n}-day aggregate leaderboard`,
    chartRevenueAgg: (n: number) => `Revenue Top 8 · ${n}d aggregate (K USD)`,
    chartDownloadsAgg: (n: number) => `Downloads Top 8 · ${n}d aggregate (K)`,
