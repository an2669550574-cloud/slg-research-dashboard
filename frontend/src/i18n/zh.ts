export const zh = {
  ...
  dashboard: {
    ...
    viewToday: '单市场 · 今日',
    viewTotal: '合计 · 区间',
    periodSub: (n: number) => `近 ${n} 天`,
    statDownloadsTotal: (n: number) => `近 ${n} 天总下载量`,
    statRevenueTotal: (n: number) => `近 ${n} 天总收入估算`,
    statTopGameTotalSub: 'TOP 收入',
    aggBoardTitle: (n: number) => `近 ${n} 天合计排行`,
    chartRevenueAgg: (n: number) => `收入 Top 8 · 近 ${n} 天合计（千美元）`,
    chartDownloadsAgg: (n: number) => `下载量 Top 8 · 近 ${n} 天合计（千次）`,
