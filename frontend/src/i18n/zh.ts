...
export const zh = {
  ...
  tagsManage: {
    ...
    noProducts: '暂无可选产品',
    // 标签包：把一级标签分组成自定义大类（视图不是分区，一个标签可同属多个包）
    packsTitle: '标签包',
    packsHint: '把一级标签分组成大类，素材库可按包切换分面；一个标签可同属多个包',
    packAdd: '新建标签包',
    packAddTitle: '新建标签包',
    packEditTitle: '编辑标签包',
    packEmpty: '暂无标签包，点击"新建标签包"把一级标签分组成大类',
    packNameLabel: '包名称（必填，最多 20 字）',
    packNamePlaceholder: '如：物资链路 / 投放要点',
