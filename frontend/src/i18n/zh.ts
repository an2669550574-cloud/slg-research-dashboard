...
export const zh = {
  ...
  productsManage: {
    ...
    matchKeywordsLabel: '对标关键词（逗号分隔，选填）',
    matchKeywordsPlaceholder: '如：丧尸,末日,survival,zombie',
    matchKeywordsHint: '每日 digest 用这些词匹配竞品名 + 中文摘要，命中就给该竞品打「⚔️ 对标《本品》」，让领导一眼看出威胁我方哪款。挑区分度高的题材词，避免「war」这类泛词全命中。',
    matchKeywordsBadge: '对标词',
